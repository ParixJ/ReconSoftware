...
| Trial balance and prior-year comparison | `B03`, `P01`, `P02`, `PY01` | Trial-balance checks require separately supplied complete trial balances. `PY01` accepts structured prior-year report rows and surfaces disclosure/opening carry-forward differences. |
| AIS, Form 26AS and GST supporting evidence | `AIS01`, `AIS02`, `A26`, `G01`, `G02`, `G03`, `X01` | Only normalized, verified measures and approved account roles are compared. `G03` expands GST cash/credit tax-head buckets across IGST, CGST, SGST and cess. |
| MSME, stock, bank, loan, advance tax and TDS auditor | `M01`, `S02`, `BK01`, `L01`, `AT01`, `TDS01` | These checks consume explicit structured supporting sources and auditor-approved book account roles. They produce review evidence; they do not replace reviewer judgment for legal exceptions, timing allocation or confirmations. |
...
Reference-HTML parity is currently verified only for the suspense, pending-GST and prepaid-reversal candidates in a reproducible browser fixture (`SCRUTINY_REFERENCE_PARITY=1 node --test test/referenceHtmlParity.test.js`). New `B06`–`B11`, `P02`, `PY01`, `M01`, `G03`, `S02`, `BK01`, `L01`, `AT01`, and `TDS01` checks expose reference-style scrutiny modules with provenance, but never infer a missing balance or elevate a name-only clue to a definitive conclusion. The manual checklist is displayed in the report page. Remaining parity work is native PDF parsing for every support type, transaction-level matching for bank/GST/loans, editable reviewer allocation screens, and accountant-approved fixture packs.
