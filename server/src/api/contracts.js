...
export const API_CONTRACTS = Object.freeze({
  ...
  documents: ["GET /api/documents", "POST /api/documents/upload", "GET /api/documents/:id", "DELETE /api/documents/:id", "PUT /api/documents/:id/mapping", "PUT /api/documents/:id/view-preference"],
